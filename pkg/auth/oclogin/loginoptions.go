// Copied from github.com/openshift/origin/pkg/oc/cli/login and modified
...
func (o *LoginOptions) gatherProjectInfo() error {
	...
	case 0:
		...
		msg := noProjectsExistMessage(canRequest, o.CommandName)
...
func noProjectsExistMessage(canRequestProjects bool, commandName string) string {
	...
	return fmt.Sprintf("You don't have any projects.\n")
}