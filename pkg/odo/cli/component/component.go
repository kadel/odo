...
func NewCmdComponent(name, fullName string) *cobra.Command {
	...
	pushDevfile := NewCmdPushDevfile(PushDevfileRecommendedCommandName, odoutil.GetFullName(fullName, PushDevfileRecommendedCommandName))
	...
	componentCmd.AddCommand(componentGetCmd, createCmd, deleteCmd, describeCmd, linkCmd, unlinkCmd, listCmd, logCmd, pushCmd, updateCmd, watchCmd, pushDevfile)
